...
Review `tests/e2e-v2/TEST_PLAN.md` to find tests to implement:
...
1. **Page Object** - `tests/e2e-v2/pages/{feature}/{Feature}Page.ts`
2. **Test Data Factory** - `tests/e2e-v2/test-data/{feature}/index.ts`
3. **Fixture** (if new page) - Update `tests/e2e-v2/fixtures/base.ts`
4. **Test File** - `tests/e2e-v2/tests/{feature}/{action}/*.spec.ts`
...
Mark implemented tests as ✅ in `tests/e2e-v2/TEST_PLAN.md`
