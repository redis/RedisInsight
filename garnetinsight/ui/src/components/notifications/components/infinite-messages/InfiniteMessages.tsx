...
export const INFINITE_MESSAGES: InfiniteMessagesType = {
  ...
  PENDING_CREATE_DB: (step?: CloudJobStep) => ({
    ...
    description: (
      <>
        ...
        <Spacer size="m" />
        You can continue working in Garnet Insight, and we will notify you once
        done.
      </>
    ),
  }),
  ...
  DATABASE_IMPORT_FORBIDDEN: (onClose?: () => void) => ({
    ...
    description: (
      <>
        Adding your Redis Cloud database to Garnet Insight is disabled due to a
  ...
  APP_UPDATE_AVAILABLE: (version: string, onSuccess?: () => void) => ({
    ...
    description: (
      <>
        With Garnet Insight {version} you have access to new useful features and
        optimizations.
        <Spacer size="m" />
        Restart Garnet Insight to install updates.
      </>
    ),
    actions: {
