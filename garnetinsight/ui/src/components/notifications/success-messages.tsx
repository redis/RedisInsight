...
export default {
  ADDED_NEW_INSTANCE: (instanceName: string) => ({
    ...
    message: (
      <Text component="span">
        ...
        has been added to Garnet Insight.
      </Text>
    ),
  }),
  ...
  DELETE_INSTANCE: (instanceName: string) => ({
    ...
    message: (
      <Text component="span">
        ...
        has been deleted from Garnet Insight.
      </Text>
    ),
  }),
      ...
      message: (
        <>
          <Text component="span">
            ...
            databases have been deleted from Garnet Insight:
          </Text>
      ...
      message: (
        <>
          <Text component="span">
            ...
            instances have been deleted from Garnet Insight:
          </Text>
          <ul style={{ marginBottom: 0 }}>
            {instanceNames.slice(0, limitShowRemovedInstances).map((el, i) => (
              // eslint-disable-next-line react/no-array-index-key
  ...
  REMOVED_ALL_CAPI_KEYS: () => ({
    ...
    message: 'All API keys have been removed from Garnet Insight.',
  }),
  REMOVED_CAPI_KEY: (name: string) => ({
    title: 'API Key has been removed',
    message: `${formatNameShort(name)} has been removed from Garnet Insight.`,
  }),
