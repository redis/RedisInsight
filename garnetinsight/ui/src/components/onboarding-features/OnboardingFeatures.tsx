...
const ONBOARDING_FEATURES = {
  ...
  BROWSER_COPILOT: {
    ...
    Inner: () => {
      ...
      return {
        content:
          'Garnet Copilot is an AI-powered companion that lets you learn about Garnet and explore your data, in a conversational manner, while also providing context-aware assistance to build search queries.',
        onSkip: () => sendClosedTelemetryEvent(...telemetryArgs),
        onBack: () => sendBackTelemetryEvent(...telemetryArgs),
        onNext: () => {
          dispatch(openCli())
  ...
  BROWSER_CLI: {
    ...
    Inner: () => {
      ...
      return {
        content: 'Use CLI to run Garnet commands.',
        onSkip: () => sendClosedTelemetryEvent(...telemetryArgs),
        onBack: () => {
          if (isAnyChatAvailable) {
            dispatch(changeSidePanel(SidePanels.AiAssistant))
  ...
  BROWSER_COMMAND_HELPER: {
    ...
    Inner: () => {
      ...
      return {
        content: (
          <>
            Command Helper lets you search and learn more about Garnet commands,
  ...
  BROWSER_PROFILER: {
    ...
    Inner: () => {
      ...
      return {
        content: (
          <>
            Use Profiler to track commands sent against the Garnet server in
            real-time.
            <Spacer size="xs" />
            Select <b>Start Profiler</b> to stream back every command processed
            by the Garnet server. Save the log to download and investigate
            commands.
            <Spacer size="xs" />
  ...
  WORKBENCH_PAGE: {
    ...
    Inner: () => {
      ...
      return {
        content: (
          <>
            This is Workbench, our advanced CLI for Garnet commands.
            <Spacer size="xs" />
  ...
  EXPLORE_REDIS: {
    ...
    Inner: () => {
      ...
      return {
        content:
          'Learn more about how Garnet can solve your use cases using interactive Tutorials.',
        onSkip: () => sendClosedTelemetryEvent(...telemetryArgs),
        onBack: () => {
          history.push(Pages.workbench(connectedInstanceId))
          dispatch(changeSidePanel(null))
  ...
  EXPLORE_CUSTOM_TUTORIALS: {
    ...
    Inner: () => {
      ...
      return {
        content: (
          <>
            Share your Garnet expertise with your team and the wider community by
            building custom Garnet Insight tutorials.
            <Spacer size="xs" />
            Use our{' '}
            <Link
            ...
            to describe your implementations of Garnet for other users to follow
            and interact with in the context of a connected Garnet database
          </>
        ),
        onSkip: () => sendClosedTelemetryEvent(...telemetryArgs),
        onBack: () => sendBackTelemetryEvent(...telemetryArgs),
  ...
  ANALYTICS_RECOMMENDATIONS: {
    ...
    Inner: () => {
      ...
      return {
        content:
          'See tips to optimize the memory usage, performance and increase the security of your Garnet database',
        onSkip: () => sendClosedTelemetryEvent(...telemetryArgs),
        onBack: () => sendBackTelemetryEvent(...telemetryArgs),
        onNext: () => {
          history.push(Pages.slowLog(connectedInstanceId))
      ...
      return {
        content: (
          <>
            ...
            your Garnet database. Customize parameters to capture logs.
          </>
        ),
        onSkip: () => sendClosedTelemetryEvent(...telemetryArgs),
        onBack: () => {
  ...
  PUB_SUB_PAGE: {
    ...
    Inner: () => {
      ...
      return {
        content: (
          <>
            Use Garnet pub/sub to subscribe to channels and post messages to
            channels.
            <Spacer size="xs" />
