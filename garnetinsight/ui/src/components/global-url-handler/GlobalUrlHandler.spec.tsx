...
const fromUrl =
  'garnetinsight://databases/connect?redisUrl=redis://default:password@localhost:6379&databaseAlias=My Name&redirect=workbench?guidePath=/quick-guides/document/introduction.md&cloudBdbId=1232&subscriptionType=fixed&planMemoryLimit=30&memoryLimitMeasurementUnit=mb&free=true&target=_blank'
...
describe('GlobalUrlHandler', () => {
  ...
  it('should call proper actions to open page', async () => {
    const fromUrl = 'garnetinsight://open?redirect=/integrate'
  ...
  it('should call proper actions to open page and copilot, onboarding', async () => {
    const fromUrl =
      'garnetinsight://open?redirect=/integrate&copilot=true&onboarding=true'
