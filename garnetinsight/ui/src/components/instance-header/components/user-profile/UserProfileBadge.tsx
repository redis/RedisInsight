...
import { buildGarnetinsightUrl, getUtmExternalLink } from 'uiSrc/utils/links'
...
const UserProfileBadge = (props: UserProfileBadgeProps) => {
  ...
  const riDesktopLink = buildGarnetinsightUrl(connectedInstance)
                  ...
                  <Menu.Content.Item.Compose>
                    <Menu.Content.Item.Text>
                      <Link
                        ...
                        variant="inline"
                      >
                        Open in Garnet Insight Desktop version
                      </Link>
                    </Menu.Content.Item.Text>
                  </Menu.Content.Item.Compose>
                  <Menu.Content.Item.Compose>
