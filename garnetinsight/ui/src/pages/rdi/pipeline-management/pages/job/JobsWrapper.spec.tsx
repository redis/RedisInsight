...
describe('JobWrapper', () => {
  ...
  it('should render proper link', () => {
    ...
    expect(
      ...
      'href',
      'https://redis.io/docs/latest/integrate/redis-data-integration/ingest/data-pipelines/transform-examples/?utm_source=garnetinsight&utm_medium=rdi&utm_campaign=job_file',
    )
  })
