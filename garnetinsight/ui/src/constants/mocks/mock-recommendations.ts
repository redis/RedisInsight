    ...
    content: [
      {
        type: 'paragraph',
        value:
          'Try Garnet Insight Workbench, our advanced command-line interface with syntax highlighting, intelligent auto-complete, and the ability to work with commands in an editor mode.',
      },
      {
        type: 'spacer',
        value: 'l',
