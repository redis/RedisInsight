...
export enum TelemetryEvent {
  ...
  UPDATE_NOTIFICATION_DOWNLOAD_CLICKED = 'UPDATE_NOTIFICATION_DOWNLOAD_CLICKED',
  UPDATE_NOTIFICATION_SKIPPED = 'UPDATE_NOTIFICATION_SKIPPED',
  ...
  PROD_MODE_PROMOTION_PROMPT_DISPLAYED = 'PROD_MODE_PROMOTION_PROMPT_DISPLAYED',
  PROD_MODE_PROMOTION_PROMPT_MARK_AS_PRODUCTION_CLICKED = 'PROD_MODE_PROMOTION_PROMPT_MARK_AS_PRODUCTION_CLICKED',
  PROD_MODE_PROMOTION_PROMPT_NOT_NOW_CLICKED = 'PROD_MODE_PROMOTION_PROMPT_NOT_NOW_CLICKED',
  ...
  BROWSER_JSON_VALUE_COPIED = 'BROWSER_JSON_VALUE_COPIED',
  BROWSER_JSON_VALUE_DOWNLOADED = 'BROWSER_JSON_VALUE_DOWNLOADED',
  ...
  SETTINGS_UPDATE_STRATEGY_CHANGED = 'SETTINGS_UPDATE_STRATEGY_CHANGED',
  ...
  STRING_VALUE_COPIED = 'STRING_VALUE_COPIED',
  ...
  TREE_VIEW_JSON_VALUE_COPIED = 'TREE_VIEW_JSON_VALUE_COPIED',
  TREE_VIEW_JSON_VALUE_DOWNLOADED = 'TREE_VIEW_JSON_VALUE_DOWNLOADED',
  ...
  WHATS_NEW_OPENED = 'WHATS_NEW_OPENED',
  WHATS_NEW_CLOSED = 'WHATS_NEW_CLOSED',
  WHATS_NEW_VERSION_CHANGED = 'WHATS_NEW_VERSION_CHANGED',
  WHATS_NEW_CARD_LINK_CLICKED = 'WHATS_NEW_CARD_LINK_CLICKED',
  ...
  // --- Vector Set: key details / view ---
  VECTOR_SET_KEY_VIEWED = 'VECTOR_SET_KEY_VIEWED',
  VECTOR_SET_ELEMENT_VECTOR_VIEWED = 'VECTOR_SET_ELEMENT_VECTOR_VIEWED',
  VECTOR_SET_ELEMENT_VECTOR_COPIED = 'VECTOR_SET_ELEMENT_VECTOR_COPIED',
  VECTOR_SET_ELEMENT_VECTOR_DOWNLOADED = 'VECTOR_SET_ELEMENT_VECTOR_DOWNLOADED',
  VECTOR_SET_ELEMENT_ATTRIBUTES_VIEWED = 'VECTOR_SET_ELEMENT_ATTRIBUTES_VIEWED',
  VECTOR_SET_ELEMENTS_FILTERED = 'VECTOR_SET_ELEMENTS_FILTERED',

  // Vector Set: CRUD on elements
  VECTOR_SET_ELEMENT_ADDED = 'VECTOR_SET_ELEMENT_ADDED',
  VECTOR_SET_ELEMENT_DELETED = 'VECTOR_SET_ELEMENT_DELETED',
  VECTOR_SET_ELEMENT_ATTRIBUTES_EDITED = 'VECTOR_SET_ELEMENT_ATTRIBUTES_EDITED',

  // --- Array: query runs ---
  ARRAY_VIEW_QUERY_RUN = 'ARRAY_VIEW_QUERY_RUN',
  ARRAY_SEARCH_QUERY_RUN = 'ARRAY_SEARCH_QUERY_RUN',
  ARRAY_AGGREGATE_QUERY_RUN = 'ARRAY_AGGREGATE_QUERY_RUN',

  // Array: CRUD on elements
  ARRAY_ELEMENT_ADDED = 'ARRAY_ELEMENT_ADDED',
  ARRAY_ELEMENT_EDITED = 'ARRAY_ELEMENT_EDITED',
  ARRAY_ELEMENT_DELETED = 'ARRAY_ELEMENT_DELETED',
  ARRAY_RANGE_DELETED = 'ARRAY_RANGE_DELETED',

  // Array: create new
  ARRAY_CREATED = 'ARRAY_CREATED',
  ARRAY_SAMPLE_DATASET_LOADED = 'ARRAY_SAMPLE_DATASET_LOADED',

  // Vector Set: custom columns
  VECTOR_SET_ATTRIBUTE_COLUMN_ADDED = 'VECTOR_SET_ATTRIBUTE_COLUMN_ADDED',
  VECTOR_SET_ATTRIBUTE_COLUMN_REMOVED = 'VECTOR_SET_ATTRIBUTE_COLUMN_REMOVED',

  // Vector Set: create new
  VECTOR_SET_CREATED = 'VECTOR_SET_CREATED',
  VECTOR_SET_SAMPLE_DATASET_LOADED = 'VECTOR_SET_SAMPLE_DATASET_LOADED',

  // Vector Set: similarity search
  VECTOR_SET_FIND_SIMILAR_CLICKED = 'VECTOR_SET_FIND_SIMILAR_CLICKED',
  VECTOR_SET_SIMILARITY_SEARCH_SUBMITTED = 'VECTOR_SET_SIMILARITY_SEARCH_SUBMITTED',
  VECTOR_SET_SIMILARITY_SEARCH_RESULTS_CLEARED = 'VECTOR_SET_SIMILARITY_SEARCH_RESULTS_CLEARED',
  VECTOR_SET_SIMILARITY_SEARCH_FORM_RESET = 'VECTOR_SET_SIMILARITY_SEARCH_FORM_RESET',
  VECTOR_SET_SIMILARITY_SEARCH_COMMAND_PREVIEW_TOGGLED = 'VECTOR_SET_SIMILARITY_SEARCH_COMMAND_PREVIEW_TOGGLED',
  VECTOR_SET_ATTRIBUTE_FILTER_SYNTAX_VIEWED = 'VECTOR_SET_ATTRIBUTE_FILTER_SYNTAX_VIEWED',

  // Vector Set: browser integration
  VECTOR_SET_KEY_TYPE_FILTERED = 'VECTOR_SET_KEY_TYPE_FILTERED',
}
