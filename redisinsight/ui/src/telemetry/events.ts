...
export enum TelemetryEvent {
  ...
  /** @deprecated Replaced in v2 */
  VECTOR_SEARCH_ONBOARDING_TRIGGERED = 'VECTOR_SEARCH_ONBOARDING_TRIGGERED_DEPRECATED',
  /** @deprecated Replaced in v2 */
  VECTOR_SEARCH_ONBOARDING_PROCEED_TO_INDEX_INFO = 'VECTOR_SEARCH_ONBOARDING_PROCEED_TO_INDEX_INFO_DEPRECATED',
  /** @deprecated Replaced in v2 */
  VECTOR_SEARCH_ONBOARDING_PROCEED_TO_QUERIES = 'VECTOR_SEARCH_ONBOARDING_PROCEED_TO_QUERIES_DEPRECATED',
  /** @deprecated Replaced in v2 */
  SEARCH_SAVED_QUERIES_PANEL_OPENED = 'SEARCH_SAVED_QUERIES_PANEL_OPENED_DEPRECATED',
  /** @deprecated Replaced in v2 */
  SEARCH_SAVED_QUERIES_PANEL_CLOSED = 'SEARCH_SAVED_QUERIES_PANEL_CLOSED_DEPRECATED',
  /** @deprecated Replaced in v2 */
  SEARCH_SAVED_QUERIES_INSERT_CLICKED = 'SEARCH_SAVED_QUERIES_INSERT_CLICKED_DEPRECATED',
  /** @deprecated Replaced in v2 */
  SEARCH_SAVED_QUERIES_INDEX_CHANGED = 'SEARCH_SAVED_QUERIES_INDEX_CHANGED_DEPRECATED',
  /** @deprecated No longer applicable in v2 UI */
  SEARCH_CLEAR_EDITOR_CLICKED = 'SEARCH_CLEAR_EDITOR_CLICKED_DEPRECATED',
  /** @deprecated Replaced in v2 */
  SEARCH_MANAGE_INDEXES_DRAWER_OPENED = 'SEARCH_MANAGE_INDEXES_DRAWER_OPENED_DEPRECATED',
  /** @deprecated Replaced in v2 */
  SEARCH_MANAGE_INDEXES_DRAWER_CLOSED = 'SEARCH_MANAGE_INDEXES_DRAWER_CLOSED_DEPRECATED',
  /** @deprecated Replaced in v2 */
