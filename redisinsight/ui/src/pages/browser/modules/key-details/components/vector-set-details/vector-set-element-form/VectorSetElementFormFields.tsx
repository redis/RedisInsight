    ...
    <EntryContent>
      ...
      >
        {(item, index) => {
          ...
          const vectorInfo = getVectorFieldInfo(item.vector, rowVectorDim, t)
          ...
          return (
            <Col gap="s">
              <Row align="start" gap="m">
                <FlexItem grow>
                  <FormField
                    additionalText={t('browser.vectorSet.form.nameHelp')}
                  >
                    <TextInput
                      required
                      aria-required="true"
                      ...
                      placeholder={t(
                        'browser.vectorSet.form.elementNamePlaceholder',
                      )}
                      value={item.name}
                      onChange={(value) =>
                    ...
                    <TextInput
                      ...
                      placeholder={
                        rowVectorDim !== undefined
                          ? t('browser.vectorSet.form.vectorPlaceholderDim', {
                              count: rowVectorDim,
                            })
                          : t('browser.vectorSet.form.vectorPlaceholder')
                      }
                      value={item.vector}
                      onChange={(value) =>
              ...
              <Row align="center" gap="s">
                ...
                >
                  <Text>{t('browser.vectorSet.form.addAttributes')} </Text>
                  <IconButton
                    icon={
                ...
                <Text color="secondary">
                  {t('browser.vectorSet.form.optional')}
                </Text>
              </Row>
              {item.showAttributes && (
                <AttributeEditor
